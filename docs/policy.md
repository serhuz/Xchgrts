...
This privacy policy applies to the Xchgrts app (hereby referred to as "Application") for mobile
devices that was created by Sergei Munovarov (hereby referred to as "Service Provider") as a Free
...
via the Application, please contact them at sergei.munovarov@gmail.com and they will respond in a
reasonable time.
...
Service Provider (sergei.munovarov@gmail.com) so that they will be able to take the necessary
actions.
...
practices, please contact the Service Provider via email at sergei.munovarov@gmail.com.
